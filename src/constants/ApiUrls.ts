export enum ApiUrls {
    URL_COURSES = "services/courseservice/api/courses",
    URL_CHAPTERS = "services/courseservice/api/chapters",
    URL_PROGRESS = "services/courseservice/api/progress",
    URL_CONTENTREFERENCES = "services/courseservice/api/contentreferences",
